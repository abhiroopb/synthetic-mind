...
Implementation phase of the RPI (Research, Plan, Implement) methodology. Executes approved plans phase by phase with verification.
...
- `rpi-plan` — Planning phase (produces the plan this skill executes)
