...
1. Go to https://registry.sqprod.co/applications/device-settings
...
2. Use the playpen in curl commands:
   ...
   sq curl --playpen device-settings -L --post302 \
     ...
     --data-raw '{"service_name": "squareup.devicesettings.profiles.v2.service.DeviceProfileV2Service", "method_name": "AdminSearchDeviceProfileHistory", "json_body": "{\"merchant_id\":\"TEST_MERCHANT\",\"types\":[\"CREATE_DEVICE_PROFILE\"],\"limit\":10}"}'
   ```

## Environments

- **Staging**: `https://device-settings.stage.sqprod.co`
- **Production**: `https://device-settings.sqprod.co`
