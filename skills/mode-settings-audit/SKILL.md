...
Use authenticated `curl` to interact with the Mode API:

```bash
# List workspaces
curl "https://app.mode.com/api/<org>/spaces"

# Get data sources
curl "https://app.mode.com/api/<org>/data_sources"

# Get workspace members
curl "https://app.mode.com/api/<org>/memberships"

# Get report details
curl "https://app.mode.com/api/<org>/reports/<report_token>"
```
