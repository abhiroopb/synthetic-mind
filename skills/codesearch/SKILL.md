---
name: codesearch
description: "Searches Square's internal Sourcegraph codesearch (codesearch.sqprod.co) across all repositories. Use when asked to search code, find implementations, locate usages, or explore codebases across Square/Block."
---

# Codesearch

Search Square's internal codebase via Sourcegraph at codesearch.sqprod.co.
...
|--------|---------|-------------|
| `repo:` | `repo:square/web` | Scope to a specific repo |
...
```
repo:square/web repo:square/api someFunction
```
...
```
search_code(query="repo:square/web TODO", n=500, output_to_disk=True)
```
