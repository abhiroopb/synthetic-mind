---
name: product
description: Searches and reads from the squareup/product repository. Use when searching existing product requirements, end-to-end feature architecture, or browsing product documentation.
---

# Product Repository Search

Search and read product requirements, end-to-end feature architecture, and other documentation from the `squareup/product` repository.

## Prerequisites

- `gh` CLI (GitHub CLI) authenticated with access to squareup/product
