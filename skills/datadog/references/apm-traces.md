...
Common workflow: find a Datadog trace from an internal trace ID, then link to the trace UI.
...
```
https://<your-datadog-instance>.datadoghq.com/apm/trace/<dd_trace_id>
```
