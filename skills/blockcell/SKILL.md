---
name: blockcell
description: Deploy static website prototypes and demos to Blockcell hosting service for internal sharing at Block.
metadata:
  status: experimental
  author: block
  version: "0.1"
...
**What to tell the user:** The site is live at `https://blockcell.sqprod.co/sites/YOUR-SITE-NAME/`
