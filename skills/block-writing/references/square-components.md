# Brand A Component Content Guidelines
...
**Product examples**:
- Brand A POS: "Process payment", "Add item", "Close register", "Print receipt"
- Brand A Dashboard: "Generate report", "Export data", "Update settings"
- Brand A Online: "Publish site", "Add product", "Manage orders"
