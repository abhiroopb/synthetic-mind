# Block Writing Standards Skill

> Complete writing expertise for all Block products and communications

An Agent Skill that transforms AI assistants into comprehensive Block writing experts. Provides guidance from initial content strategy through final copy review, with integrated brand voice standards and real Block content creation workflows.
...
- Component-specific writing guidance from Cash App's Arcade Design System and Square's Market Design System
- Block voice principles applied to specific content types and contexts
...
- Brand-specific adaptations for Cash App, Square, Afterpay, Tidal, Bitkey, and Proto

### 📝 **Style and Mechanics Support**
- Comprehensive style guidelines integrated with Block voice standards
...
- Validate content against Block writing standards and voice principles
...
These standards apply to all Block products:
- **Cash App** - Consumer financial services
- **Square** - Merchant and business tools
...
Try asking Claude:
```
Write a button label for saving user preferences that follows Block voice principles
```
...
Write an error message for a failed payment that follows Block voice principles
```
...
**Verify Installation:**
```
Write an error message for a failed Cash App payment that follows Block voice principles
```

Goose should respond with specific Block writing guidance including voice principles, style mechanics, and content best practices.
...
```
How should I write push notification copy for a Cash App promotion?
```

```
Review this marketing email for Block voice consistency
```
...
# 2. Get Block writing guidance on the analysis
Review this content analysis for Block writing standards compliance.
...
Review this payment confirmation copy for Block voice principles.
...
# 2. Review findings with Block standards
I found these content files in my project. Can you help me audit them for Block voice consistency?
...
memory__remember_memory category:"current_project" data:"Redesigning Cash App error messages. Focus on reducing user anxiety while being upfront about issues." is_global:false
...
Write button copy for an Arcade modal that follows both Block writing standards and Arcade content guidelines.
...
- **`foundations-block-voice-principles.md`**: Complete guide to Block's four voice principles (crisp, self-assured, fluent, upfront) with tactics and examples
...
- **`product-point-of-view.md`**: Pronoun usage and perspective consistency across Block products
- **`product-numbers.md`**: Formatting standards for currency, dates, phone numbers, and abbreviations
- **`product-cash-app-transactional-communications.md`**: Email, SMS, and push notification guidelines and templates
- **`product-cash-app-legal-footers.md`**: Legal copy and compliance language standards

**Creative Marketing Guidelines:**
- **`creative-square-style-guide.md`**: Square-specific brand voice, messaging, and style guidelines
- **`creative-cash-app-growth-writing-guidelines.md`**: Growth messaging frameworks and positioning strategies
- **`creative-creative-afterpay-cash-app-guidelines.md`**: Afterpay product messaging and brand voice standards
- **`creative-creative-cash-app-growth-messaging-framework.md`**: Strategic messaging frameworks for product marketing
- **`creative-creative-cash-app-financial-inclusion-whitepaper.md`**: Financial education and thought leadership content standards
...
- **`support-cash-app-web-help-template.md`**: Standardized template for Cash App help articles and web content
...
- **`component-arcade-content-guidelines.md`**: Comprehensive content standards for UI components across Block products, with primary guidance from Cash App's Arcade Design System
- **`component-square-content-guidelines.md`**: Square-specific component content standards for Market Design System, with business-focused voice and merchant audience adaptations
...
- **Transactional Comms**: `product-cash-app-transactional-communications.md`

### Product-Specific Guidelines
- **Cash App**: Multiple documents across both creative-marketing and product-writing
- **Square**: `creative-square-style-guide.md`
- **Afterpay**: `creative-creative-afterpay-cash-app-guidelines.md`
...
**Marketing campaigns**: Begin with `creative-cash-app-growth-writing-guidelines.md` and relevant product guidelines
**Help articles**: Use `support-writing-principles.md` and appropriate article templates
**Email/SMS**: Reference `product-cash-app-transactional-communications.md`
**Legal copy**: Consult `product-cash-app-legal-footers.md`
...
- **Products**: `cash-app`, `square`, `afterpay`, `tidal`, `bitkey`, `proto`
...
**Skill loads but doesn't provide Block writing guidance:**
```bash
# Verify skill content is present
developer__text_editor path:~/.config/goose/skills/block-writing/SKILL.md command:view

# Try a specific Block writing query
Write a Cash App error message that follows Block voice principles
```
...
memory__remember_memory category:"voice_preferences" data:"Cash App onboarding: conversational and empowering. Error messages: upfront but reassuring." is_global:false tags:["voice", "cash-app"]
...
# Get Block writing guidance
Review this content analysis for Block writing standards compliance. Focus on: voice consistency, style mechanics, accessibility.
```
...
**Maintained By**: Block Writing Team  
