...
```tsx
import { MarketPagingTabs, MarketSegmentedControl } from '@squareup/market-react/trial';
```
...
- Both components are **trial** exports — import from `@squareup/market-react/trial`.
