...
```tsx
import { MarketPagingTabs, MarketPagingTabList, MarketPagingTab, MarketPagingTabPanel } from '@your-org/market-react/trial';
...
```tsx
import { MarketSegmentedControl } from '@your-org/market-react/trial';
