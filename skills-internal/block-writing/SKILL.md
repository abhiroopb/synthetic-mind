---
name: block-writing
description: Use when writing, reviewing, drafting, editing, auditing, or revising Block product content — Cash App, Square, Afterpay, Tidal, Bitkey, or Proto. Covers UI copy, marketing, support articles, transactional communications, and legal copy. Applies Block's voice principles and accessibility standards.
metadata:
  author: claydelk
  version: "1.1.0"
  status:
...
This skill helps you create and review content that aligns with Block's brand voice and meets standards for clarity, accessibility, and user experience.

**STOP** — Before proceeding, confirm:
1. **Which product?** (Cash App, Square, Afterpay, Tidal, Bitkey, Proto) — voice, terminology, and component rules differ by product
...
- [ ] **Identify the context** — Product (Cash App, Square, Afterpay, Tidal, Bitkey, Proto), content type (UI, marketing, support, legal), audience (consumer or merchant), and component if applicable

- [ ] **Apply Block voice principles** — Apply all four in order:
...
- [ ] **Apply function-specific standards** — Choose based on content type:
  ...
  - *Component content*: Cash App → [arcade-universal-standards.md](references/arcade-universal-standards.md); Square → [square-voice-standards.md](references/square-voice-standards.md); decision support → [decision-trees-product-context.md](references/decision-trees-product-context.md)
  - *Marketing*: see Marketing Content routing section below for Cash App growth, Square, or Afterpay-specific files
  - *Support*: [references/support-writing-principles.md](references/support-writing-principles.md) + relevant article guide

- [ ] **Verify terminology** — Product names must match exactly (Cash App Card, not "Cash Card"); use current terms (withdraw, not "cash out") ([references/terminology-cash-app.md](references/terminology-cash-app.md))
...
#### WHEN user mentions Cash App:
→ Load [references/product-voice-cash-app.md](references/product-voice-cash-app.md)

#### WHEN user mentions Square:
→ Load [references/product-voice-square.md](references/product-voice-square.md)

#### WHEN user mentions Afterpay, Tidal, Bitkey, or Proto:
...
#### WHEN questions about Cash App product names, feature names, or money movement terms:
→ Load [references/terminology-cash-app.md](references/terminology-cash-app.md)

#### WHEN questions about Square product names or audience terms:
→ Load [references/terminology-square.md](references/terminology-square.md)

#### WHEN questions about Afterpay, Tidal, Bitkey, Proto, or Block corporate names:
...
#### WHEN working on Cash App / Arcade Design System components:
...
#### WHEN working on Square / Market Design System components:
...
- **Product context (Cash App vs Square vs others)** → [decision-trees-product-context.md](references/decision-trees-product-context.md)
...
#### WHEN working on Cash App email campaigns:
→ Load [references/growth-writing-email.md](references/growth-writing-email.md)

#### WHEN working on Cash App push notifications or ads:
→ Load [references/growth-writing-push-ads.md](references/growth-writing-push-ads.md)

#### WHEN working on Cash App growth messaging — banking features (banking, direct deposit, overdraft, savings, ATM):
→ Load [references/growth-messaging-banking.md](references/growth-messaging-banking.md)

#### WHEN working on Cash App growth messaging — Cash App Card, offers, or Round Ups:
→ Load [references/growth-messaging-card.md](references/growth-messaging-card.md)

#### WHEN working on Cash App growth messaging — stocks, bitcoin, Cash App Pay, or security:
→ Load [references/growth-messaging-investing-pay.md](references/growth-messaging-investing-pay.md)

#### WHEN working on Square marketing — grammar, style, or mechanics (punctuation, numbers, dates):
→ Load [references/square-style-grammar.md](references/square-style-grammar.md)

#### WHEN working on Square marketing — content guidelines, readability, or formatting:
→ Load [references/square-style-content.md](references/square-style-content.md)

#### WHEN working on Square marketing — inclusivity, technology terms, or localization:
→ Load [references/square-style-inclusivity.md](references/square-style-inclusivity.md)

#### WHEN working on Square marketing — specific word choices or term spellings:
...
#### WHEN working on Afterpay marketing — brand strategy or naming:
→ Load [references/afterpay-brand-strategy.md](references/afterpay-brand-strategy.md)

#### WHEN working on Afterpay marketing — UI patterns or notifications:
→ Load [references/afterpay-ui-patterns.md](references/afterpay-ui-patterns.md)

#### WHEN working on Afterpay marketing — terminology or compliance language:
...
#### WHEN writing financial education or thought leadership content about Cash App:
...
- **IF** Cash App web help → [support-cash-app-web-help.md](references/support-cash-app-web-help.md)
...
→ Load [references/product-cash-app-transactional-communications.md](references/product-cash-app-transactional-communications.md)
...
#### WHEN working on legal copy for Cash App Card, bitcoin, investing, or borrow:
...
- `arcade-design-review` — Use when validating or selecting Arcade design system components; pairs well with this skill when reviewing component content in Cash App UI
