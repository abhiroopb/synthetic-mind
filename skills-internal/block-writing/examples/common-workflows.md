...
**Scenario**: Consumer product — user taps a CTA to send money to a contact.
...
**Scenario**: Brand B — P2P payment fails due to insufficient balance.
...
**Scenario**: Reviewing a Brand B modal before launch.
