...
```tsx
import { MarketAccordion, MarketAccordionGroup } from '@your-org/market-react/trial';
...
>
  <MarketAccordion
    ...
    id="faq-1"
  >
    <p>Market is your company's design system.</p>
  </MarketAccordion>
  <MarketAccordion
    header="How do I get started?"
    id="faq-2"
  >
    <p>Install @your-org/market-react.</p>
  </MarketAccordion>
  <MarketAccordion
    header="Is it free?"
    id="faq-3"
