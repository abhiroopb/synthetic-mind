...
```tsx
import { MarketQrCode } from '@your-org/market-react/trial';
```
...
// Basic QR code
<MarketQrCode content="https://example.com/store/my-shop" />

// QR code with border and fixed size
<MarketQrCode
  border
  content="https://example.com/pay/abc123"
  size={200}
/>
...
<MarketQrCode
  border
  monochrome
  content="https://example.com/appointments/book/xyz"
  size={300}
/>
```
