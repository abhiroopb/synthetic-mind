...
import type { MarketButtonProps } from '@your-org/market-react';
...
7. `MarketButtonGroup` is a **trial** component — import from `@your-org/market-react/trial`, not the main export.
