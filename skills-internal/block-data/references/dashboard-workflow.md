...
Call `mcp__mcp-block-data__dashboard_search` with:
...
When the user selects a dashboard, call `mcp__mcp-block-data__run_dashboard` with:
...
Call `mcp__mcp-block-data__run_dashboard` again with:
