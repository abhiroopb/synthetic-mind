...
VALID_BRANDS = ["Square", "Brand B", "Block", "Afterpay", "Tidal", "Bitkey"]
...
def get_snowflake_connection(
    ...
    user = os.getenv("SNOWFLAKE_USER") or f"{getpass.getuser()}@example.com"
        ...
        for table in tables:
            ...
            try:
                ...
                if "does not exist or not authorized" in error_msg:
                    access_url = f"https://registry.internal.example.com/groups/{app_name}--snowflake__read_only"
                inaccessible.append({
                    "table": table,
                    "database": parts[0],
                    "error": str(e),
...
Environment variables:
  ...
  SNOWFLAKE_USER                  Snowflake username (default: $USER@example.com)
  ...
  QUERY_EXPERT_KNOWLEDGE_DIR      Path to knowledge directory
    ...
    sp.add_argument("--brand", help="Brand: Square, Brand B, Afterpay, Tidal, Bitkey, Block")
    ...
    sp.add_argument("--brand", help="Brand: square, brand_b, afterpay")
