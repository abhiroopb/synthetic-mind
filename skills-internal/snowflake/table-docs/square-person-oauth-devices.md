# Square Person, OAuth & Devices

Query and analyze Square person identity, OAuth authorizations, device registry, and merchant/employee data from Snowflake.

## Tables

### PERSON.RAW_OLTP.PROFILES

Primary source of all person_token values that exist at Square. Each row represents a unique person.
This table is fundamental for user identity management.

### PERSON.RAW_OLTP.ALIASES
...
|----------|--------|-------|-------------|
| PERSON | RAW_OLTP | PROFILES | Primary source of all person_token values at Square. Each row represents a unique person. |
