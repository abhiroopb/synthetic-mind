...
### APP_CASH.CASH_DATA_BOT.LIMIT_DECISION_EVENTS
...
at `cash-limits/protos/src/main/proto/squareup/cash/cashlimits/events/limit_decision_event.proto`. The core decision
...
| 7 | EVENTLY_TYPE | TEXT | N | | Proto type of the event | `type.googleapis.com/squareup.cash.cashlimits.events.LimitDecisionEvent` |
...
FROM APP_CASH.CASH_DATA_BOT.LIMIT_DECISION_EVENTS,
...
JOIN APP_CASH.CASH_DATA_BOT.P2PENGINE_PAYMENT_STATE_EVENTS pses
